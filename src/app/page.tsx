  ...
  return (
    <li className="flex gap-4">
      <div className="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full ring-1 shadow-md shadow-zinc-800/5 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0">
        <Image src={role.logo} alt="" className="h-7 w-7 rounded-full" unoptimized width={28} height={28}/>
      </div>
...
function Resume() {
  let resume: Array<Role> = [
    ...
    },
    {
      ...
      logo: 'https://media.licdn.com/dms/image/v2/D4D0BAQEk4IbW5ncHlg/company-logo_100_100/company-logo_100_100/0/1719924329365/convenia_hrtech_logo?e=1749081600&v=beta&t=YHQ0ycxKqK3xaB89iYZDYJknQ-QVLElQnSaKnR3W7tI',
      start: '2022',
      end: '2023',
    },
    {
      ...
      logo: 'https://media.licdn.com/dms/image/v2/D4D0BAQFppA9JagNvtA/company-logo_100_100/company-logo_100_100/0/1736350667304?e=1749081600&v=beta&t=leFM3N34p-MojigDdcir2No27K4dmed1EpDEsqdPw_c',
      start: '2021',
      end: '2022',
    },
    {
      ...
      logo: 'https://media.licdn.com/dms/image/v2/D4D0BAQHf-sGSGnJwsQ/company-logo_100_100/company-logo_100_100/0/1729078429483/ufpb_logo?e=1749081600&v=beta&t=UCL7-DOWqUxab8u2S8GeiP8r2CLbFRGY40XZsgoV4ms',
      start: '2019',
      end: '2021',
    },
  ]
