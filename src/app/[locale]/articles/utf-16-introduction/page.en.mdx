...
In the [next post](https://lenildo.com/en/articles/unicode-fundamentals), you'll discover that the simple "A" on your screen is just the tip of a software engineering iceberg.
