...
For decades, different regions of the world created their own solutions – encoding tables like ISO-8859-1 (Latin-1) for Western European languages, Windows-1252, Shift-JIS for Japanese, and hundreds of others. The result was predictable: a document created on one system appeared as [gibberish](https://en.wikipedia.org/wiki/Gibberish) on another.
